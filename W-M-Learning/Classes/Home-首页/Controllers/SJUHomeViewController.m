...
@interface SJUHomeViewController ()
...
@implementation SJUHomeViewController
...
- (void)viewDidLoad {
    ...
    // 设置菜单背景色
    _slideMenu.ll_menuBackgroundColor = DLRandomColor;
    ...
    UIButton *leftButton = [[UIButton alloc]initWithFrame:CGRectMake(5, 5, 30, 50)];
    [self.view addSubview:leftButton];
    [leftButton setImage:[UIImage imageNamed:@"icon_menu"] forState:UIControlStateNormal];
    [leftButton addTarget:self action:@selector(openLLSlideMenuAction:) forControlEvents:UIControlEventTouchUpInside];
